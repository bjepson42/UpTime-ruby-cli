...
dance = Possibility.create(name: "Dance", description: "Get off your butt and dance!", physical_intensity: 4, mental_intensity: 1, fun_index: 5, duration_in_minutes: nil, necessary_location: "home", others_required: nil)
